...
const MONTHS: { label: string; incidents: Incident[] }[] = [
  {
    ...
    incidents: [
      ...
      { daysAgo: 95, hour: 11, error_step: 'Drug picked from shelf', error_types: ['Wrong strength picked'], drug_name: 'Atorvastatin', prescribed_strength: '20mg', dispensed_strength: '40mg', where_caught: 'Final pharmacist check', factors: ['Busy period', 'Similar packaging'], outcome: 'accepted' },
      { daysAgo: 92, hour: 12, error_step: 'Drug picked from shelf', error_types: ['Wrong strength picked'], drug_name: 'Atorvastatin', prescribed_strength: '40mg', dispensed_strength: '20mg', where_caught: 'Final pharmacist check', factors: ['Interruption or distraction'], outcome: 'accepted' },
      { daysAgo: 88, hour: 13, error_step: 'Drug picked from shelf', error_types: ['Wrong strength picked'], drug_name: 'Atorvastatin', prescribed_strength: '20mg', dispensed_strength: '80mg', where_caught: 'Final pharmacist check', factors: ['Similar packaging', 'Busy period'], outcome: 'modified' },
      ...
      { daysAgo: 78, hour: 14, error_step: 'Drug picked from shelf', error_types: ['Wrong strength picked'], drug_name: 'Atorvastatin', prescribed_strength: '20mg', dispensed_strength: '40mg', where_caught: 'Initial pharmacist check', factors: ['Similar packaging', 'Busy period'], outcome: 'accepted' },
      // High-risk: warfarin
      { daysAgo: 90, hour: 10, error_step: 'Script entered into dispensary software', error_types: ['Wrong strength entered'], drug_name: 'Warfarin', prescribed_strength: '1mg', dispensed_strength: '3mg', where_caught: 'Data entry check', factors: ['Interruption or distraction'], outcome: 'accepted' },
      // Codeine mix-up
      { daysAgo: 85, hour: 15, error_step: 'Labelling', error_types: ['Wrong directions'], drug_name: 'Codeine phosphate', where_caught: 'Final pharmacist check', factors: ['Usual process skipped'], outcome: 'modified' },
      // Salbutamol formulation
      { daysAgo: 80, hour: 11, error_step: 'Drug picked from shelf', error_types: ['Wrong formulation'], drug_name: 'Salbutamol', correct_formulation: 'Inhaler', dispensed_formulation: 'Nebule', where_caught: 'Technician spotted it', factors: ['Similar packaging'], outcome: 'accepted' },
      ...
      { daysAgo: 73, hour: 12, error_step: 'Labelling', error_types: ['Wrong directions'], drug_name: 'Methotrexate', where_caught: 'Final pharmacist check', factors: ['Unfamiliar drug', 'Message not passed on'], outcome: 'accepted', notes: 'Directions read daily instead of weekly — caught and corrected before patient left.' },
      // Wrong patient
      { daysAgo: 70, hour: 16, error_step: 'Bagging / handed to patient', error_types: ['Wrong patient label'], where_caught: 'Final pharmacist check', factors: ['Busy period'], outcome: 'no_action' },
      // Voided incident (data quality / submitted in error)
      { daysAgo: 87, hour: 14, error_step: 'Drug picked from shelf', error_types: ['Wrong drug picked'], drug_name: 'Ibuprofen', where_caught: 'Technician spotted it', factors: [], status: 'voided', void_reason: 'Duplicate entry — same incident was logged twice.' },
    ],
  },
  {
    label: '~2 months ago',
    incidents: [
      ...
      { daysAgo: 55, hour: 13, error_step: 'Drug picked from shelf', error_types: ['Wrong strength picked'], drug_name: 'Atorvastatin', prescribed_strength: '40mg', dispensed_strength: '20mg', where_caught: 'Initial pharmacist check', factors: ['Busy period'], outcome: 'accepted' },
      ...
      // Metformin
      { daysAgo: 52, hour: 14, error_step: 'Script entered into dispensary software', error_types: ['Wrong directions'], drug_name: 'Metformin', where_caught: 'Data entry check', factors: ['Interruption or distraction'], outcome: 'accepted' },
      ...
      // Allergy override
      { daysAgo: 45, hour: 15, error_step: 'Script entered into dispensary software', error_types: ['Allergy warning ignored'], drug_name: 'Amoxicillin', where_caught: 'Initial pharmacist check', factors: ['Message not passed on'], outcome: 'modified', notes: 'Allergy alert dismissed without review — patient flagged penicillin allergy.' },
      // Quantity miscount
  ...
  },
  {
    ...
    incidents: [
      ...
      { daysAgo: 28, hour: 13, error_step: 'Drug picked from shelf', error_types: ['Wrong strength picked'], drug_name: 'Atorvastatin', prescribed_strength: '40mg', dispensed_strength: '20mg', where_caught: 'Final pharmacist check', factors: ['Busy period'], outcome: 'accepted' },
      ...
      { daysAgo: 20, hour: 10, error_step: 'Labelling', error_types: ['Wrong directions'], drug_name: 'Warfarin', where_caught: 'Final pharmacist check', factors: ['Message not passed on'], outcome: 'modified', notes: 'Direction "5mg daily" labelled as "5mg twice daily".' },
      ...
      // Pack size
      { daysAgo: 15, hour: 15, error_step: 'Drug picked from shelf', error_types: ['Wrong pack size'], drug_name: 'Paracetamol', where_caught: 'Technician spotted it', factors: ['Busy period'], outcome: 'accepted' },
      // CD dispensing
      { daysAgo: 12, hour: 14, error_step: 'Controlled drug dispensing', error_types: ['Register not signed'], drug_name: 'Methadone', where_caught: 'Final pharmacist check', factors: ['Usual process skipped'], outcome: 'modified', notes: 'Doses dispensed but CD register entry missed.' },
    ],
  },
  {
    ...
    incidents: [
      ...
      { daysAgo: 5, hour: 13, error_step: 'Script entered into dispensary software', error_types: ['Wrong patient'], where_caught: 'Data entry check', factors: ['Interruption or distraction'] },
      { daysAgo: 3, hour: 10, error_step: 'Labelling', error_types: ['Wrong directions'], drug_name: 'Sertraline', where_caught: 'Final pharmacist check', factors: ['Usual process skipped'] },
      { daysAgo: 1, hour: 14, error_step: 'Counted / measured', error_types: ['Wrong quantity counted'], drug_name: 'Diazepam', where_caught: 'Final pharmacist check', factors: ['Interruption or distraction'] },
    ],
  },
];
