...
const PERIOD_2_INCIDENTS: Incident[] = [
  ...
  { dayOfMonth: 7, hour: 16, error_step: 'Drug picked from shelf', error_types: ['Wrong brand supplied'], drug_name: 'Quetiapine', where_caught: 'Final pharmacist check', factors: ['Usual process skipped'], outcome: 'no_action' },
...
const PERIOD_3_INCIDENTS: Incident[] = [
  ...
  { dayOfMonth: 17, hour: 12, error_step: 'Drug picked from shelf', error_types: ['Wrong brand supplied'], drug_name: 'Losartan', where_caught: 'Final pharmacist check', factors: ['Usual process skipped'], outcome: 'no_action' },
