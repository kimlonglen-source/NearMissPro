...
export const FACTOR_SUGGESTIONS: Record<string, string> = {
  ...
  'System slow or down': 'Tell your dispensary-software vendor about the slowness. Write down a paper-based backup process so you can keep dispensing safely if the system goes down.',
...
const FACTOR_INLINE_FIXES: Record<string, string> = {
  ...
  'System slow or down': 'tell your dispensary-software vendor and document a paper-backup process for outages',
