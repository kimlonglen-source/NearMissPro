...
- Logging: seconds / a few taps every time, instead of writing a paragraph — biggest saving lands on the checking pharmacist who logs them all day.
