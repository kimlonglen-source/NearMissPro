  ...
  const groups: { heading: string; items: { q: string; a: string }[] }[] = [
    {
      ...
      items: [
        ...
        { q: 'Is it a problem that the data is offshore, not in NZ?', a: 'No. The Privacy Act 2020 allows New Zealand data to be held overseas where it\'s protected by comparable privacy law — Australia qualifies. And because the app holds no patient information, what\'s stored is anonymous near-miss records, not health data. Sydney is the closest region to NZ, which keeps it fast.' },
        { q: 'Does the Health Information Privacy Code apply?', a: 'The Health Information Privacy Code 2020 governs identifiable patient health information. NearMissPro is deliberately built not to collect any — no patient fields, and the notes box blocks names, NHI, DOB and phone numbers. So the Code\'s health-information rules don\'t bite. Your pharmacy stays the agency responsible for anything a staff member types in by mistake, and we\'ll help you redact or delete it.' },
        { q: 'How long is our data kept, and who owns it?', a: 'Your pharmacy owns its data. We keep it while your account is active, then for 12 months after cancellation in case you reactivate, then delete it — or sooner on request. Near-miss records can count as workplace safety records (Health and Safety at Work Act), so we recommend downloading your data periodically to keep your own copy for however long your practice requires.' },
        { q: 'Can we get our records for a Pharmacy Council review or an audit?', a: 'Any time. Settings has a one-click export of everything — near misses, reports and the full timestamped audit log — as a single file you can hand to an inspector or keep on the dispensary computer.' },
