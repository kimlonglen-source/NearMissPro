...
export const STAGES: Stage[] = [
  ...
  },
  {
    ...
    subErrors: [
      ...
      { label: 'Wrong drug on label', common: false },
      { label: 'Wrong quantity on label', common: false },
      { label: 'Missing CAL (cautionary advisory label)', common: false },
      { label: 'Wrong CAL applied', common: false },
