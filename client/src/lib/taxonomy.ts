...
export const STAGES: Stage[] = [
  {
    ...
    subErrors: [
      ...
      { label: 'Wrong quantity entered', common: true },
      { label: 'Repeat dispensed too early', common: true },
      { label: 'Allergy missed or overridden', common: true },
      { label: 'Interaction missed', common: true },
  ...
  },
  {
    ...
    subErrors: [
      ...
      { label: 'Wrong drug \u2014 sound-alike name', common: true },
      { label: 'Wrong strength picked', common: true },
      { label: 'Wrong formulation picked', common: true },
      { label: 'Expired stock', common: true },
      { label: 'Damaged tablets', common: true },
      { label: 'Wrong brand (bioequivalence)', common: true },
      { label: 'Wrong pack size', common: true },
  ...
  },
  {
    ...
    subErrors: [
      { label: 'Wrong patient on label', common: true },
      { label: 'Wrong drug on label', common: true },
      { label: 'Wrong strength on label', common: true },
      { label: 'Wrong directions / SIG on label', common: true },
      { label: 'Typo on label', common: true },
      { label: 'Wrong quantity on label', common: true },
      { label: 'Missing CAL (cautionary advisory label)', common: true },
      { label: 'Wrong CAL applied', common: true },
      { label: 'Label on wrong item / wrong bottle', common: false },
      { label: 'Missing label entirely', common: false },
      { label: 'Wrong frequency on label', common: false },
      { label: 'Wrong route on label', common: false },
      { label: 'Wrong dispensed date', common: false },
      { label: 'Wrong expiry on label', common: false },
  ...
  },
  {
    ...
    subErrors: [
      ...
      { label: 'Bag contains extra item', common: true },
      { label: 'Counselling missed', common: true },
      { label: 'Counselling incorrect', common: true },
      { label: 'New-medicine counselling missed', common: true },
      { label: 'Inhaler or device technique not shown', common: true },
  ...
  },
  {
    ...
    subErrors: [
      ...
      { label: 'Methadone observed dose not witnessed', common: true },
      { label: 'CD safe left unlocked', common: true },
      { label: 'CD destroyed without proper witness', common: true },
      { label: 'Out-of-date CD prescription dispensed', common: true },
    ],
  },
  {
...
export const CAUGHT_DEFAULT_BY_STAGE: Record<string, string> = {
  ...
  'Label generated': 'Final pharmacist check',
